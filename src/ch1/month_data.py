...
CONNSTRING = 'dbname=postgres user=postgres password=stanislav100 application_name=factbook'
...
# result = fetch_month_data(2010, 3)
# print(result)

def list_book_for_month(year, month):
    """List all days for given month and for each day list factbook entry"""
...
if __name__ == '__main__':
    #run using: python .\month_data.py 2010 3
    year = int(sys.argv[1])
    month = int(sys.argv[2])
    list_book_for_month(2010, 3)
